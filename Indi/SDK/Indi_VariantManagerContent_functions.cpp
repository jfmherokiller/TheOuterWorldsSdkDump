...
#include "Indi_VariantManagerContent_parameters.hpp"
...
void ALevelVariantSetsActor::STATIC_SetLevelVariantSets(class ULevelVariantSets* InVariantSets)
{
...
void UVariant::STATIC_SetDisplayText(const struct FText& NewDisplayText)
{
...
void UVariantSet::STATIC_SetDisplayText(const struct FText& NewDisplayText)
{
