...
#include "Indi_EditableMesh_parameters.hpp"
...
void UEditableMesh::STATIC_WeldVertices(TArray<struct FVertexID> VertexIDs, struct FVertexID* OutNewVertexID)
{
...
void UEditableMesh::STATIC_TryToRemoveVertex(const struct FVertexID& VertexID, bool* bOutWasVertexRemoved, struct FEdgeID* OutNewEdgeID)
{
...
void UEditableMesh::STATIC_TryToRemovePolygonEdge(const struct FEdgeID& EdgeID, bool* bOutWasEdgeRemoved, struct FPolygonID* OutNewPolygonID)
{
...
void UEditableMesh::STATIC_TriangulatePolygons(TArray<struct FPolygonID> PolygonIDs, TArray<struct FPolygonID>* OutNewTrianglePolygons)
{
...
void UEditableMesh::STATIC_TessellatePolygons(TArray<struct FPolygonID> PolygonIDs, ETriangleTessellationMode TriangleTessellationMode, TArray<struct FPolygonID>* OutNewPolygonIDs)
{
...
void UEditableMesh::STATIC_StartModification(EMeshModificationType MeshModificationType, EMeshTopologyChange MeshTopologyChange)
{
...
void UEditableMesh::STATIC_SplitPolygons(TArray<struct FPolygonToSplit> PolygonsToSplit, TArray<struct FEdgeID>* OutNewEdgeIDs)
{
...
void UEditableMesh::STATIC_SplitEdge(const struct FEdgeID& EdgeID, TArray<float> Splits, TArray<struct FVertexID>* OutNewVertexIDs)
{
...
void UEditableMesh::STATIC_SetVerticesCornerSharpness(TArray<struct FVertexID> VertexIDs, TArray<float> VerticesNewCornerSharpness)
{
...
void UEditableMesh::STATIC_SetVerticesAttributes(TArray<struct FAttributesForVertex> AttributesForVertices)
{
...
void UEditableMesh::STATIC_SetVertexInstancesAttributes(TArray<struct FAttributesForVertexInstance> AttributesForVertexInstances)
{
...
void UEditableMesh::STATIC_SetTextureCoordinateCount(int NumTexCoords)
{
...
void UEditableMesh::STATIC_SetSubdivisionCount(int NewSubdivisionCount)
{
...
void UEditableMesh::STATIC_SetPolygonsVertexAttributes(TArray<struct FVertexAttributesForPolygon> VertexAttributesForPolygons)
{
...
void UEditableMesh::STATIC_SetEdgesVertices(TArray<struct FVerticesForEdge> VerticesForEdges)
{
...
void UEditableMesh::STATIC_SetEdgesHardnessAutomatically(TArray<struct FEdgeID> EdgeIDs, float MaxDotProductForSoftEdge)
{
...
void UEditableMesh::STATIC_SetEdgesHardness(TArray<struct FEdgeID> EdgeIDs, TArray<bool> EdgesNewIsHard)
{
...
void UEditableMesh::STATIC_SetEdgesCreaseSharpness(TArray<struct FEdgeID> EdgeIDs, TArray<float> EdgesNewCreaseSharpness)
{
...
void UEditableMesh::STATIC_SetEdgesAttributes(TArray<struct FAttributesForEdge> AttributesForEdges)
{
...
void UEditableMesh::STATIC_SetAllowUndo(bool bInAllowUndo)
{
...
void UEditableMesh::STATIC_SetAllowSpatialDatabase(bool bInAllowSpatialDatabase)
{
...
void UEditableMesh::STATIC_SetAllowCompact(bool bInAllowCompact)
{
...
void UEditableMesh::STATIC_SearchSpatialDatabaseForPolygonsPotentiallyIntersectingLineSegment(const struct FVector& LineSegmentStart, const struct FVector& LineSegmentEnd, TArray<struct FPolygonID>* OutPolygons)
{
...
void UEditableMesh::STATIC_SearchSpatialDatabaseForPolygonsInVolume(TArray<struct FPlane> Planes, TArray<struct FPolygonID>* OutPolygons)
{
...
void UEditableMesh::STATIC_Revert()
{
...
void UEditableMesh::STATIC_RemovePolygonPerimeterVertices(const struct FPolygonID& PolygonID, int FirstVertexNumberToRemove, int NumVerticesToRemove, bool bDeleteOrphanedVertexInstances)
{
...
void UEditableMesh::STATIC_RebuildRenderMesh()
{
...
void UEditableMesh::STATIC_QuadrangulateMesh(TArray<struct FPolygonID>* OutNewPolygonIDs)
{
...
void UEditableMesh::STATIC_PropagateInstanceChanges()
{
...
void UEditableMesh::STATIC_MoveVertices(TArray<struct FVertexToMove> VerticesToMove)
{
...
void UEditableMesh::STATIC_InsetPolygons(TArray<struct FPolygonID> PolygonIDs, float InsetFixedDistance, float InsetProgressTowardCenter, EInsetPolygonsMode Mode, TArray<struct FPolygonID>* OutNewCenterPolygonIDs, TArray<struct FPolygonID>* OutNewSidePolygonIDs)
{
...
void UEditableMesh::STATIC_InsertPolygonPerimeterVertices(const struct FPolygonID& PolygonID, int InsertBeforeVertexNumber, TArray<struct FVertexAndAttributes> VerticesToInsert)
{
...
void UEditableMesh::STATIC_InsertEdgeLoop(const struct FEdgeID& EdgeID, TArray<float> Splits, TArray<struct FEdgeID>* OutNewEdgeIDs)
{
...
void UEditableMesh::STATIC_InitializeAdapters()
{
...
void UEditableMesh::STATIC_GetVertexInstanceConnectedPolygons(const struct FVertexInstanceID& VertexInstanceID, TArray<struct FPolygonID>* OutConnectedPolygonIDs)
{
...
void UEditableMesh::STATIC_GetVertexConnectedPolygons(const struct FVertexID& VertexID, TArray<struct FPolygonID>* OutConnectedPolygonIDs)
{
...
void UEditableMesh::STATIC_GetVertexConnectedEdges(const struct FVertexID& VertexID, TArray<struct FEdgeID>* OutConnectedEdgeIDs)
{
...
void UEditableMesh::STATIC_GetVertexAdjacentVertices(const struct FVertexID& VertexID, TArray<struct FVertexID>* OutAdjacentVertexIDs)
{
...
void UEditableMesh::STATIC_GetPolygonPerimeterVertices(const struct FPolygonID& PolygonID, TArray<struct FVertexID>* OutPolygonPerimeterVertexIDs)
{
...
void UEditableMesh::STATIC_GetPolygonPerimeterVertexInstances(const struct FPolygonID& PolygonID, TArray<struct FVertexInstanceID>* OutPolygonPerimeterVertexInstanceIDs)
{
...
void UEditableMesh::STATIC_GetPolygonPerimeterEdges(const struct FPolygonID& PolygonID, TArray<struct FEdgeID>* OutPolygonPerimeterEdgeIDs)
{
...
void UEditableMesh::STATIC_GetPolygonHoleVertices(const struct FPolygonID& PolygonID, int HoleNumber, TArray<struct FVertexID>* OutHoleVertexIDs)
{
...
void UEditableMesh::STATIC_GetPolygonHoleVertexInstances(const struct FPolygonID& PolygonID, int HoleNumber, TArray<struct FVertexInstanceID>* OutHoleVertexInstanceIDs)
{
...
void UEditableMesh::STATIC_GetPolygonHoleEdges(const struct FPolygonID& PolygonID, int HoleNumber, TArray<struct FEdgeID>* OutHoleEdgeIDs)
{
...
void UEditableMesh::STATIC_GetPolygonAdjacentPolygons(const struct FPolygonID& PolygonID, TArray<struct FPolygonID>* OutAdjacentPolygons)
{
...
void UEditableMesh::STATIC_GetEdgeVertices(const struct FEdgeID& EdgeID, struct FVertexID* OutEdgeVertexID0, struct FVertexID* OutEdgeVertexID1)
{
...
void UEditableMesh::STATIC_GetEdgeLoopElements(const struct FEdgeID& EdgeID, TArray<struct FEdgeID>* EdgeLoopIDs)
{
...
void UEditableMesh::STATIC_GetEdgeConnectedPolygons(const struct FEdgeID& EdgeID, TArray<struct FPolygonID>* OutConnectedPolygonIDs)
{
...
void UEditableMesh::STATIC_GeneratePolygonTangentsAndNormals(TArray<struct FPolygonID> PolygonIDs)
{
...
void UEditableMesh::STATIC_FlipPolygons(TArray<struct FPolygonID> PolygonIDs)
{
...
void UEditableMesh::STATIC_FindPolygonLoop(const struct FEdgeID& EdgeID, TArray<struct FEdgeID>* OutEdgeLoopEdgeIDs, TArray<struct FEdgeID>* OutFlippedEdgeIDs, TArray<struct FEdgeID>* OutReversedEdgeIDPathToTake, TArray<struct FPolygonID>* OutPolygonIDsToSplit)
{
...
void UEditableMesh::STATIC_ExtrudePolygons(TArray<struct FPolygonID> Polygons, float ExtrudeDistance, bool bKeepNeighborsTogether, TArray<struct FPolygonID>* OutNewExtrudedFrontPolygons)
{
...
void UEditableMesh::STATIC_ExtendVertices(TArray<struct FVertexID> VertexIDs, bool bOnlyExtendClosestEdge, const struct FVector& ReferencePosition, TArray<struct FVertexID>* OutNewExtendedVertexIDs)
{
...
void UEditableMesh::STATIC_ExtendEdges(TArray<struct FEdgeID> EdgeIDs, bool bWeldNeighbors, TArray<struct FEdgeID>* OutNewExtendedEdgeIDs)
{
...
void UEditableMesh::STATIC_EndModification(bool bFromUndo)
{
...
void UEditableMesh::STATIC_DeleteVertexInstances(TArray<struct FVertexInstanceID> VertexInstanceIDsToDelete, bool bDeleteOrphanedVertices)
{
...
void UEditableMesh::STATIC_DeleteVertexAndConnectedEdgesAndPolygons(const struct FVertexID& VertexID, bool bDeleteOrphanedEdges, bool bDeleteOrphanedVertices, bool bDeleteOrphanedVertexInstances, bool bDeleteEmptyPolygonGroups)
{
...
void UEditableMesh::STATIC_DeletePolygons(TArray<struct FPolygonID> PolygonIDsToDelete, bool bDeleteOrphanedEdges, bool bDeleteOrphanedVertices, bool bDeleteOrphanedVertexInstances, bool bDeleteEmptyPolygonGroups)
{
...
void UEditableMesh::STATIC_DeletePolygonGroups(TArray<struct FPolygonGroupID> PolygonGroupIDs)
{
...
void UEditableMesh::STATIC_DeleteOrphanVertices(TArray<struct FVertexID> VertexIDsToDelete)
{
...
void UEditableMesh::STATIC_DeleteEdges(TArray<struct FEdgeID> EdgeIDsToDelete, bool bDeleteOrphanedVertices)
{
...
void UEditableMesh::STATIC_DeleteEdgeAndConnectedPolygons(const struct FEdgeID& EdgeID, bool bDeleteOrphanedEdges, bool bDeleteOrphanedVertices, bool bDeleteOrphanedVertexInstances, bool bDeleteEmptyPolygonGroups)
{
...
void UEditableMesh::STATIC_CreateVertices(TArray<struct FVertexToCreate> VerticesToCreate, TArray<struct FVertexID>* OutNewVertexIDs)
{
...
void UEditableMesh::STATIC_CreateVertexInstances(TArray<struct FVertexInstanceToCreate> VertexInstancesToCreate, TArray<struct FVertexInstanceID>* OutNewVertexInstanceIDs)
{
...
void UEditableMesh::STATIC_CreatePolygons(TArray<struct FPolygonToCreate> PolygonsToCreate, TArray<struct FPolygonID>* OutNewPolygonIDs, TArray<struct FEdgeID>* OutNewEdgeIDs)
{
...
void UEditableMesh::STATIC_CreatePolygonGroups(TArray<struct FPolygonGroupToCreate> PolygonGroupsToCreate, TArray<struct FPolygonGroupID>* OutNewPolygonGroupIDs)
{
...
void UEditableMesh::STATIC_CreateMissingPolygonPerimeterEdges(const struct FPolygonID& PolygonID, TArray<struct FEdgeID>* OutNewEdgeIDs)
{
...
void UEditableMesh::STATIC_CreateMissingPolygonHoleEdges(const struct FPolygonID& PolygonID, int HoleNumber, TArray<struct FEdgeID>* OutNewEdgeIDs)
{
...
void UEditableMesh::STATIC_CreateEmptyVertexRange(int NumVerticesToCreate, TArray<struct FVertexID>* OutNewVertexIDs)
{
...
void UEditableMesh::STATIC_CreateEdges(TArray<struct FEdgeToCreate> EdgesToCreate, TArray<struct FEdgeID>* OutNewEdgeIDs)
{
...
void UEditableMesh::STATIC_ComputePolygonTriangulation(const struct FPolygonID& PolygonID, TArray<struct FMeshTriangle>* OutTriangles)
{
...
void UEditableMesh::STATIC_ComputePolygonsSharedEdges(TArray<struct FPolygonID> PolygonIDs, TArray<struct FEdgeID>* OutSharedEdgeIDs)
{
...
void UEditableMesh::STATIC_Commit()
{
...
void UEditableMesh::STATIC_ChangePolygonsVertexInstances(TArray<struct FChangeVertexInstancesForPolygon> VertexInstancesForPolygons)
{
...
void UEditableMesh::STATIC_BevelPolygons(TArray<struct FPolygonID> PolygonIDs, float BevelFixedDistance, float BevelProgressTowardCenter, TArray<struct FPolygonID>* OutNewCenterPolygonIDs, TArray<struct FPolygonID>* OutNewSidePolygonIDs)
{
...
void UEditableMesh::STATIC_AssignPolygonsToPolygonGroups(TArray<struct FPolygonGroupForPolygon> PolygonGroupForPolygons, bool bDeleteOrphanedPolygonGroups)
{
