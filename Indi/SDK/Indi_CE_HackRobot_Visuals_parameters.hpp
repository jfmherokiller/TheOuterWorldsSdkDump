...
#include "Indi_CE_HackRobot_Visuals_classes.hpp"
...
struct UCE_HackRobot_Visuals_C_ReceiveClearEffect_Params
{
	class AActor**                                     Target;                                                   // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function CE_HackRobot_Visuals.CE_HackRobot_Visuals_C.ReceiveApplyEffect
struct UCE_HackRobot_Visuals_C_ReceiveApplyEffect_Params
{
	class AActor**                                     Target;                                                   // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
...
struct UCE_HackRobot_Visuals_C_ExecuteUbergraph_CE_HackRobot_Visuals_Params
{
