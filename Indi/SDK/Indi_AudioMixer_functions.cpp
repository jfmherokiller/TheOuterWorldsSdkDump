...
#include "Indi_AudioMixer_parameters.hpp"
...
void USynthComponent::STATIC_SetVolumeMultiplier(float VolumeMultiplier)
{
...
void USubmixEffectReverbPreset::STATIC_SetSettingsWithReverbEffect(class UReverbEffect* InReverbEffect, float WetLevel, float DryLevel)
{
