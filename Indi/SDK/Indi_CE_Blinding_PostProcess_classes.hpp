...
#include "Indi_CE_Blinding_PostProcess_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass CE_Blinding_PostProcess.CE_Blinding_PostProcess_C");
		return ptr;
	}
	...
	void STATIC_ExecuteUbergraph_CE_Blinding_PostProcess(int EntryPoint);
};
