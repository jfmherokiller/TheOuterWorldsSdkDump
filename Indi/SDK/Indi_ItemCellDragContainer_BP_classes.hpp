...
#include "Indi_ItemCellDragContainer_BP_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass ItemCellDragContainer_BP.ItemCellDragContainer_BP_C");
		return ptr;
	}
	...
	void STATIC_ExecuteUbergraph_ItemCellDragContainer_BP(int EntryPoint);
};
