...
struct FJoinabilitySettings
{
	...
	bool                                               bPublicSearchable;                                        // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bAllowInvites;                                            // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bJoinViaPresence;                                         // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bJoinViaPresenceFriendsOnly;                              // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	int                                                MaxPlayers;                                               // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                MaxPartySize;                                             // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FPackedNormal
{
	...
	unsigned char                                      Y;                                                        // 0x0000(0x0001) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	unsigned char                                      Z;                                                        // 0x0000(0x0001) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	unsigned char                                      W;                                                        // 0x0000(0x0001) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
...
struct FPackedRGBA16N
{
	...
	int                                                ZW;                                                       // 0x0000(0x0004) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
};
...
struct FBox2D
{
	...
	struct FVector2D                                   Max;                                                      // 0x0000(0x0008) (Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
	unsigned char                                      bIsValid;                                                 // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FOrientedBox
{
	...
	struct FVector                                     AxisX;                                                    // 0x0000(0x000C) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	struct FVector                                     AxisY;                                                    // 0x0000(0x000C) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	struct FVector                                     AxisZ;                                                    // 0x0000(0x000C) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	float                                              ExtentX;                                                  // 0x0000(0x0004) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	float                                              ExtentY;                                                  // 0x0000(0x0004) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
	float                                              ExtentZ;                                                  // 0x0000(0x0004) (Edit, ZeroConstructor, SaveGame, IsPlainOldData)
...
struct FInterpCurveFloat
{
	...
	bool                                               bIsLooped;                                                // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
	float                                              InVal;                                                    // 0x0000(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FQuat                                       OutVal;                                                   // 0x0000(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FQuat                                       ArriveTangent;                                            // 0x0000(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FQuat                                       LeaveTangent;                                             // 0x0000(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	TEnumAsByte<EInterpCurveMode>                      InterpMode;                                               // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
	float                                              InVal;                                                    // 0x0000(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FTwoVectors                                 OutVal;                                                   // 0x0000(0x0018) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FTwoVectors                                 ArriveTangent;                                            // 0x0000(0x0018) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FTwoVectors                                 LeaveTangent;                                             // 0x0000(0x0018) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EInterpCurveMode>                      InterpMode;                                               // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4F];                                      // 0x0001(0x004F) MISSED OFFSET
};
...
struct FFrameRate
{
	...
	int                                                Denominator;                                              // 0x0000(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
};
...
struct FFrameTime
{
	...
	float                                              SubFrame;                                                 // 0x0000(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
};
...
struct FQualifiedFrameTime
{
	...
	struct FFrameRate                                  Rate;                                                     // 0x0000(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FTimecode
{
	...
	int                                                Minutes;                                                  // 0x0000(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                Seconds;                                                  // 0x0000(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                Frames;                                                   // 0x0000(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bDropFrameFormat;                                         // 0x0000(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x13];                                      // 0x0001(0x0013) MISSED OFFSET
};
...
struct FSoftObjectPath
{
	...
	class FString                                      SubPathString;                                            // 0x0000(0x0010) (ZeroConstructor)
...
struct FPrimaryAssetId
{
	...
	struct FName                                       PrimaryAssetName;                                         // 0x0000(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0008(0x0008) MISSED OFFSET
};
...
struct FFloatRange
{
	...
	struct FFloatRangeBound                            UpperBound;                                               // 0x0000(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0008(0x0008) MISSED OFFSET
};
...
struct FInt32Range
{
	...
	struct FInt32RangeBound                            UpperBound;                                               // 0x0000(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0008(0x0008) MISSED OFFSET
};
...
struct FPolyglotTextData
{
	...
	class FString                                      NativeCulture;                                            // 0x0000(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	class FString                                      Namespace;                                                // 0x0000(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	class FString                                      Key;                                                      // 0x0000(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	class FString                                      NativeString;                                             // 0x0000(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	TMap<class FString, class FString>                 LocalizedStrings;                                         // 0x0000(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	struct FText                                       CachedText;                                               // 0x0000(0x0028) (Transient)
...
struct FAutomationEvent
{
	...
	struct FGuid                                       Artifact;                                                 // 0x0000(0x0010) (ZeroConstructor, IsPlainOldData)
...
struct FAutomationExecutionEntry
{
	...
	int                                                LineNumber;                                               // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
