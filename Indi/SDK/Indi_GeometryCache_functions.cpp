...
#include "Indi_GeometryCache_parameters.hpp"
...
void UGeometryCacheComponent::STATIC_TickAtThisTime(float Time, bool bInIsRunning, bool bInBackwards, bool bInIsLooping)
{
