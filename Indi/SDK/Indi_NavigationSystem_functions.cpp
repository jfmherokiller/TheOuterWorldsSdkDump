...
#include "Indi_NavigationSystem_parameters.hpp"
...
void UNavigationSystemV1::STATIC_UnregisterNavigationInvoker(class AActor* Invoker)
{
...
void UNavigationSystemV1::STATIC_SetMaxSimultaneousTileGenerationJobsCount(int MaxNumberOfJobs)
{
...
void UNavigationSystemV1::STATIC_SetGeometryGatheringMode(ENavDataGatheringModeConfig NewMode)
{
...
void UNavigationSystemV1::STATIC_ResetMaxSimultaneousTileGenerationJobsCount()
{
...
void UNavigationSystemV1::STATIC_RegisterNavigationInvoker(class AActor* Invoker, float TileGenerationRadius, float TileRemovalRadius)
{
...
void UNavigationSystemV1::STATIC_OnNavigationBoundsUpdated(class ANavMeshBoundsVolume* NavVolume)
{
