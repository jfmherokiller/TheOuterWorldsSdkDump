...
struct FMovieSceneActorReferenceData : public FMovieSceneChannel
{
	...
	TArray<struct FMovieSceneActorReferenceKey>        KeyValues;                                                // 0x0000(0x0010) (ZeroConstructor)
...
struct FMovieSceneCameraAnimSectionData
{
	...
	float                                              PlayScale;                                                // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              BlendInTime;                                              // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              BlendOutTime;                                             // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bLooping;                                                 // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FMovieSceneCameraShakeSectionData
{
	...
	float                                              PlayScale;                                                // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ECameraAnimPlaySpace>                  PlaySpace;                                                // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	struct FRotator                                    UserDefinedPlaySpace;                                     // 0x0000(0x000C) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FEventPayload
{
	...
	struct FMovieSceneEventParameters                  Parameters;                                               // 0x0000(0x0028) (Edit, BlueprintVisible, BlueprintReadOnly)
...
struct FMovieSceneEventSectionData : public FMovieSceneChannel
{
	...
	TArray<struct FEventPayload>                       KeyValues;                                                // 0x0000(0x0010) (ZeroConstructor)
...
{
	TArray<struct FFrameNumber>                        KeyTimes;                                                 // 0x0000(0x0010) (ZeroConstructor)
	TArray<struct FMovieSceneEvent>                    KeyValues;                                                // 0x0000(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x78];                                      // 0x0010(0x0078) MISSED OFFSET
};
...
struct FScalarParameterNameAndCurve
{
	...
	struct FMovieSceneFloatChannel                     ParameterCurve;                                           // 0x0000(0x00A0)
...
{
	struct FName                                       ParameterName;                                            // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FMovieSceneFloatChannel                     XCurve;                                                   // 0x0000(0x00A0)
	struct FMovieSceneFloatChannel                     YCurve;                                                   // 0x0000(0x00A0)
	struct FMovieSceneFloatChannel                     ZCurve;                                                   // 0x0000(0x00A0)
	unsigned char                                      UnknownData00[0x148];                                     // 0x00A0(0x0148) MISSED OFFSET
};
...
{
	struct FName                                       ParameterName;                                            // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FMovieSceneFloatChannel                     RedCurve;                                                 // 0x0000(0x00A0)
	struct FMovieSceneFloatChannel                     GreenCurve;                                               // 0x0000(0x00A0)
	struct FMovieSceneFloatChannel                     BlueCurve;                                                // 0x0000(0x00A0)
	struct FMovieSceneFloatChannel                     AlphaCurve;                                               // 0x0000(0x00A0)
	unsigned char                                      UnknownData00[0x1E8];                                     // 0x00A0(0x01E8) MISSED OFFSET
};
...
struct FMovieSceneSkeletalAnimationParams
{
	...
	struct FMovieSceneFloatChannel                     Weight;                                                   // 0x0000(0x00A0)
	bool                                               bSkipAnimNotifiers;                                       // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
	TArray<struct FFrameNumber>                        Times;                                                    // 0x0000(0x0010) (ZeroConstructor)
	TArray<class FString>                              Values;                                                   // 0x0000(0x0010) (ZeroConstructor)
	class FString                                      DefaultValue;                                             // 0x0000(0x0010) (ZeroConstructor)
...
{
	struct FMovieSceneObjectBindingID                  AttachBindingID;                                          // 0x0000(0x0018)
	struct FName                                       AttachSocketName;                                         // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FName                                       AttachComponentName;                                      // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AttachmentLocationRule;                                   // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AttachmentRotationRule;                                   // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AttachmentScaleRule;                                      // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	EDetachmentRule                                    DetachmentLocationRule;                                   // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	EDetachmentRule                                    DetachmentRotationRule;                                   // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	EDetachmentRule                                    DetachmentScaleRule;                                      // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
	struct FMovieSceneObjectBindingID                  PathBindingID;                                            // 0x0000(0x0018)
	struct FMovieSceneFloatChannel                     TimingCurve;                                              // 0x0000(0x00A0)
	EMovieScene3DPathSection_Axis                      FrontAxisEnum;                                            // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	EMovieScene3DPathSection_Axis                      UpAxisEnum;                                               // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bFollow : 1;                                              // 0x0000(0x0001)
	unsigned char                                      bReverse : 1;                                             // 0x0000(0x0001)
	unsigned char                                      bForceUpright : 1;                                        // 0x0000(0x0001)
...
struct FMovieScene3DTransformTemplateData
{
	...
	struct FMovieSceneFloatChannel                     RotationCurve[0x3];                                       // 0x0000(0x00A0)
	struct FMovieSceneFloatChannel                     ScaleCurve[0x3];                                          // 0x0000(0x00A0)
	struct FMovieSceneFloatChannel                     ManualWeight;                                             // 0x0000(0x00A0)
	EMovieSceneBlendType                               BlendType;                                                // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	struct FMovieSceneTransformMask                    Mask;                                                     // 0x0000(0x0004)
	bool                                               bUseQuaternionInterpolation;                              // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x64F];                                     // 0x0001(0x064F) MISSED OFFSET
};
...
{
	struct FMovieScene3DTransformTemplateData          TemplateData;                                             // 0x0000(0x0650)
...
struct FMovieSceneActorReferenceSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	struct FMovieSceneActorReferenceData               ActorReferenceData;                                       // 0x0000(0x00A0)
...
struct FMovieSceneAudioSectionTemplateData
{
	...
	float                                              AudioStartOffset;                                         // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	double                                             SectionStartTimeSeconds;                                  // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FMovieSceneFloatChannel                     AudioPitchMultiplierCurve;                                // 0x0000(0x00A0)
	struct FMovieSceneFloatChannel                     AudioVolumeCurve;                                         // 0x0000(0x00A0)
	int                                                RowIndex;                                                 // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bOverrideAttenuation;                                     // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	class USoundAttenuation*                           AttenuationSettings;                                      // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FScriptDelegate                             OnQueueSubtitles;                                         // 0x0000(0x0014) (ZeroConstructor, InstancedReference)
	struct FScriptMulticastDelegate                    OnAudioFinished;                                          // 0x0000(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptMulticastDelegate                    OnAudioPlaybackPercent;                                   // 0x0000(0x0010) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData00[0x188];                                     // 0x0010(0x0188) MISSED OFFSET
};
...
{
	struct FMovieSceneAudioSectionTemplateData         AudioData;                                                // 0x0000(0x0198)
...
{
	struct FMovieSceneCameraShakeSectionData           SourceData;                                               // 0x0000(0x0020)
...
{
	struct FMovieSceneCameraAnimSectionData            SourceData;                                               // 0x0000(0x0020)
	struct FFrameNumber                                SectionStartTime;                                         // 0x0000(0x0004)
	unsigned char                                      UnknownData00[0x44];                                      // 0x0004(0x0044) MISSED OFFSET
};
...
{
	struct FMovieSceneObjectBindingID                  CameraBindingID;                                          // 0x0000(0x0018)
	struct FTransform                                  CutTransform;                                             // 0x0000(0x0030) (IsPlainOldData)
	bool                                               bHasCutTransform;                                         // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
	struct FMovieSceneFloatChannel                     Curves[0x4];                                              // 0x0000(0x00A0)
	EMovieSceneBlendType                               BlendType;                                                // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2CF];                                     // 0x0001(0x02CF) MISSED OFFSET
};
...
{
	TArray<struct FMovieSceneObjectBindingID>          EventReceivers;                                           // 0x0000(0x0010) (ZeroConstructor)
	unsigned char                                      bFireEventsWhenForwards : 1;                              // 0x0000(0x0001)
	unsigned char                                      bFireEventsWhenBackwards : 1;                             // 0x0000(0x0001)
...
{
	struct FName                                       EventToTrigger;                                           // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
	TArray<struct FFrameNumber>                        EventTimes;                                               // 0x0000(0x0010) (ZeroConstructor)
	TArray<struct FName>                               EventFunctions;                                           // 0x0000(0x0010) (ZeroConstructor)
...
{
	struct FMovieSceneEventSectionData                 EventData;                                                // 0x0000(0x0088)
...
{
	struct FMovieSceneFloatChannel                     FadeCurve;                                                // 0x0000(0x00A0)
	struct FLinearColor                                FadeColor;                                                // 0x0000(0x0010) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bFadeAudio : 1;                                           // 0x0000(0x0001)
...
{
	ELevelVisibility                                   Visibility;                                               // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	TArray<struct FName>                               LevelNames;                                               // 0x0000(0x0010) (ZeroConstructor)
...
{
	TArray<struct FScalarParameterNameAndCurve>        Scalars;                                                  // 0x0000(0x0010) (ZeroConstructor)
	TArray<struct FVectorParameterNameAndCurves>       Vectors;                                                  // 0x0000(0x0010) (ZeroConstructor)
	TArray<struct FColorParameterNameAndCurves>        Colors;                                                   // 0x0000(0x0010) (ZeroConstructor)
...
{
	class UMaterialParameterCollection*                MPC;                                                      // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
	struct FMovieSceneParticleChannel                  ParticleKeys;                                             // 0x0000(0x0098)
...
{
	struct FMovieSceneFloatChannel                     ComponentCurves[0x4];                                     // 0x0000(0x00A0)
	int                                                NumChannelsUsed;                                          // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	EMovieSceneBlendType                               BlendType;                                                // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2CF];                                     // 0x0001(0x02CF) MISSED OFFSET
};
...
{
	struct FMovieSceneStringChannel                    StringCurve;                                              // 0x0000(0x00A0)
	unsigned char                                      UnknownData00[0x48];                                      // 0x00A0(0x0048) MISSED OFFSET
};
...
{
	struct FMovieSceneIntegerChannel                   IntegerCurve;                                             // 0x0000(0x0090)
	EMovieSceneBlendType                               BlendType;                                                // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0xDF];                                      // 0x0001(0x00DF) MISSED OFFSET
};
...
{
	struct FMovieSceneByteChannel                      EnumCurve;                                                // 0x0000(0x0098)
...
{
	struct FMovieSceneByteChannel                      ByteCurve;                                                // 0x0000(0x0098)
	unsigned char                                      UnknownData00[0x48];                                      // 0x0098(0x0048) MISSED OFFSET
};
...
{
	struct FMovieSceneFloatChannel                     FloatFunction;                                            // 0x0000(0x00A0)
	EMovieSceneBlendType                               BlendType;                                                // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
	struct FMovieSceneBoolChannel                      BoolCurve;                                                // 0x0000(0x0090)
...
{
	struct FMovieSceneSkeletalAnimationSectionTemplateParameters Params;                                                   // 0x0000(0x00D0)
...
{
	struct FMovieSceneFloatChannel                     SlomoCurve;                                               // 0x0000(0x00A0)
...
{
	struct FMovieSceneBoolChannel                      Curve;                                                    // 0x0000(0x0090)
