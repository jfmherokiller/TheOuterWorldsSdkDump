...
#include "Indi_CE_Stun_classes.hpp"
...
struct UCE_Stun_C_ReceiveApplyEffect_Params
{
...
struct UCE_Stun_C_ReceiveClearEffect_Params
{
	class AActor**                                     Target;                                                   // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function CE_Stun.CE_Stun_C.ExecuteUbergraph_CE_Stun
struct UCE_Stun_C_ExecuteUbergraph_CE_Stun_Params
{
