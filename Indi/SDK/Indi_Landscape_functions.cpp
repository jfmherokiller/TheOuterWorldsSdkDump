...
#include "Indi_Landscape_parameters.hpp"
...
void ALandscapeProxy::STATIC_SetLandscapeMaterialVectorParameterValue(const struct FName& ParameterName, const struct FLinearColor& Value)
{
...
void ALandscapeProxy::STATIC_SetLandscapeMaterialTextureParameterValue(const struct FName& ParameterName, class UTexture* Value)
{
...
void ALandscapeProxy::STATIC_SetLandscapeMaterialScalarParameterValue(const struct FName& ParameterName, float Value)
{
...
void ALandscapeProxy::STATIC_EditorSetLandscapeMaterial(class UMaterialInterface* NewLandscapeMaterial)
{
...
void ALandscapeProxy::STATIC_ChangeUseTessellationComponentScreenSizeFalloff(bool InComponentScreenSizeToUseSubSections)
{
...
void ALandscapeProxy::STATIC_ChangeTessellationComponentScreenSizeFalloff(float InUseTessellationComponentScreenSizeFalloff)
{
...
void ALandscapeProxy::STATIC_ChangeTessellationComponentScreenSize(float InTessellationComponentScreenSize)
{
...
void ALandscapeProxy::STATIC_ChangeComponentScreenSizeToUseSubSections(float InComponentScreenSizeToUseSubSections)
{
