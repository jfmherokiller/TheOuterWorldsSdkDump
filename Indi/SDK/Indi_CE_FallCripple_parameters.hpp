...
#include "Indi_CE_FallCripple_classes.hpp"
...
struct UCE_FallCripple_C_ReceiveApplyEffect_Params
{
...
struct UCE_FallCripple_C_ReceiveClearEffect_Params
{
	class AActor**                                     Target;                                                   // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function CE_FallCripple.CE_FallCripple_C.ExecuteUbergraph_CE_FallCripple
struct UCE_FallCripple_C_ExecuteUbergraph_CE_FallCripple_Params
{
