...
struct FGrassVariety
{
	...
	struct FPerPlatformFloat                           GrassDensity;                                             // 0x0000(0x0004) (Edit)
	...
	struct FPerPlatformInt                             StartCullDistance;                                        // 0x0000(0x0004) (Edit)
	struct FPerPlatformInt                             EndCullDistance;                                          // 0x0000(0x0004) (Edit)
	int                                                MinLOD;                                                   // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EGrassScaling                                      Scaling;                                                  // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	struct FLightingChannels                           LightingChannels;                                         // 0x0000(0x0001) (Edit)
	bool                                               bReceivesDecals;                                          // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bCastDynamicShadow;                                       // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bKeepInstanceBufferCPUCopy;                               // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FLayerBlendInput
{
	...
	struct FExpressionInput                            LayerInput;                                               // 0x0000(0x0010)
	struct FExpressionInput                            HeightInput;                                              // 0x0000(0x0010)
...
struct FLandscapeEditToolRenderData
{
	...
	class UMaterialInterface*                          GizmoMaterial;                                            // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	int                                                SelectedType;                                             // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                DebugChannelR;                                            // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                DebugChannelG;                                            // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                DebugChannelB;                                            // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	class UTexture2D*                                  DataTexture;                                              // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
