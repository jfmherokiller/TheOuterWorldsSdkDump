...
#include "Indi_CinematicCamera_parameters.hpp"
...
void UCineCameraComponent::STATIC_SetLensPresetByName(const class FString& InPresetName)
{
...
void UCineCameraComponent::STATIC_SetFilmbackPresetByName(const class FString& InPresetName)
{
