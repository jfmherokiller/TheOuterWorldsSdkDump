...
#include "Indi_SC_LightPistol_Weapon_Base_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass SC_LightPistol_Weapon_Base.SC_LightPistol_Weapon_Base_C");
		return ptr;
	}
	...
	void STATIC_ExecuteUbergraph_SC_LightPistol_Weapon_Base(int EntryPoint);
};
