...
#include "Indi_CE_Burn_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass CE_Burn.CE_Burn_C");
		return ptr;
	}
	...
	void STATIC_ExecuteUbergraph_CE_Burn(int EntryPoint);
};
