...
#include "Indi_PropertyPath_classes.hpp"
#include "Indi_MovieSceneTracks_classes.hpp"
...
struct FNamedSlotBinding
{
	...
	class UWidget*                                     Content;                                                  // 0x0000(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
struct FShapedTextOptions
{
	...
	ETextShapingMethod                                 TextShapingMethod;                                        // 0x0000(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	ETextFlowDirection                                 TextFlowDirection;                                        // 0x0000(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
struct FSlateMeshVertex
{
	...
	struct FVector2D                                   UV0;                                                      // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   UV1;                                                      // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   UV2;                                                      // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   UV3;                                                      // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   UV4;                                                      // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   UV5;                                                      // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
...
struct FWidgetAnimationBinding
{
	...
	bool                                               bIsRootWidget;                                            // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FDelegateRuntimeBinding
{
	...
	struct FDynamicPropertyPath                        SourcePath;                                               // 0x0000(0x0028)
	EBindingKind                                       Kind;                                                     // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FWidgetNavigationData
{
	...
	struct FScriptDelegate                             CustomDelegate;                                           // 0x0000(0x0014) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData00[0x18];                                      // 0x0010(0x0018) MISSED OFFSET
};

// ScriptStruct UMG.SlateMetaData
// 0x0010
struct FSlateMetaData
{
...
{
	struct FMovieSceneFloatChannel                     Translation[0x2];                                         // 0x0000(0x00A0)
	struct FMovieSceneFloatChannel                     Rotation;                                                 // 0x0000(0x00A0)
	struct FMovieSceneFloatChannel                     Scale[0x2];                                               // 0x0000(0x00A0)
	struct FMovieSceneFloatChannel                     Shear[0x2];                                               // 0x0000(0x00A0)
	EMovieSceneBlendType                               BlendType;                                                // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	struct FMovieScene2DTransformMask                  Mask;                                                     // 0x0000(0x0004)
	unsigned char                                      UnknownData00[0x4AC];                                     // 0x0004(0x04AC) MISSED OFFSET
};
...
{
	struct FMovieSceneFloatChannel                     TopCurve;                                                 // 0x0000(0x00A0)
	struct FMovieSceneFloatChannel                     LeftCurve;                                                // 0x0000(0x00A0)
	struct FMovieSceneFloatChannel                     RightCurve;                                               // 0x0000(0x00A0)
	struct FMovieSceneFloatChannel                     BottomCurve;                                              // 0x0000(0x00A0)
	EMovieSceneBlendType                               BlendType;                                                // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
	TArray<struct FName>                               BrushPropertyNamePath;                                    // 0x0000(0x0010) (ZeroConstructor)
...
{
	struct FTextBlockStyle                             TextStyle;                                                // 0x0000(0x01F0) (Edit)
