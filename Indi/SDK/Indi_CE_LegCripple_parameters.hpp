...
#include "Indi_CE_LegCripple_classes.hpp"
...
struct UCE_LegCripple_C_ReceiveApplyEffect_Params
{
...
struct UCE_LegCripple_C_ReceiveClearEffect_Params
{
	class AActor**                                     Target;                                                   // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function CE_LegCripple.CE_LegCripple_C.ExecuteUbergraph_CE_LegCripple
struct UCE_LegCripple_C_ExecuteUbergraph_CE_LegCripple_Params
{
