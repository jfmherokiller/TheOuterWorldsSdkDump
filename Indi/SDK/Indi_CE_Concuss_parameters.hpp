...
#include "Indi_CE_Concuss_classes.hpp"
...
struct UCE_Concuss_C_ReceiveApplyEffect_Params
{
...
struct UCE_Concuss_C_ReceiveClearEffect_Params
{
	class AActor**                                     Target;                                                   // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function CE_Concuss.CE_Concuss_C.ExecuteUbergraph_CE_Concuss
struct UCE_Concuss_C_ExecuteUbergraph_CE_Concuss_Params
{
