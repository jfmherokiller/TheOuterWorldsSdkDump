...
#include "Indi_AssetRegistry_parameters.hpp"
...
void UAssetRegistry::STATIC_SearchAllAssets(bool bSynchronousSearch)
{
...
void UAssetRegistry::STATIC_ScanPathsSynchronous(TArray<class FString> InPaths, bool bForceRescan)
{
...
void UAssetRegistry::STATIC_ScanModifiedAssetFiles(TArray<class FString> InFilePaths)
{
...
void UAssetRegistry::STATIC_ScanFilesSynchronous(TArray<class FString> InFilePaths, bool bForceRescan)
{
...
void UAssetRegistry::STATIC_RunAssetsThroughFilter(const struct FARFilter& Filter, TArray<struct FAssetData>* AssetDataList)
{
...
void UAssetRegistry::STATIC_PrioritizeSearchPath(const class FString& PathToPrioritize)
{
...
void UAssetRegistry::STATIC_GetSubPaths(const class FString& InBasePath, bool bInRecurse, TArray<class FString>* OutPathList)
{
...
void UAssetRegistry::STATIC_GetAllCachedPaths(TArray<class FString>* OutPathList)
{
