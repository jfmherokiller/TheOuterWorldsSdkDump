...
struct FMaterialQualityOverrides
{
	...
	bool                                               bDisableMaterialNormalCalculation;                        // 0x0000(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	EMobileCSMQuality                                  MobileCSMQuality;                                         // 0x0000(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
