...
#include "Indi_Button_Ledger_Header_Container_BP_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Button_Ledger_Header_Container_BP.Button_Ledger_Header_Container_BP_C");
		return ptr;
	}
	...
	void STATIC_ExecuteUbergraph_Button_Ledger_Header_Container_BP(int EntryPoint);
};
