...
#include "Indi_OnlineSubsystemUtils_parameters.hpp"
...
void APartyBeaconClient::STATIC_ServerUpdateReservationRequest(const class FString& SessionId, const struct FPartyReservation& ReservationUpdate)
{
...
void APartyBeaconClient::STATIC_ServerReservationRequest(const class FString& SessionId, const struct FPartyReservation& Reservation)
{
