...
#include "Indi_AIModule_parameters.hpp"
...
void AAIController::STATIC_SetPathFollowingComponent(class UPathFollowingComponent* NewPFComponent)
{
...
void UBrainComponent::STATIC_StopLogic(const class FString& Reason)
{
...
// DelegateFunction AIModule.PathFollowingComponent.OnUpdatePath__DelegateSignature
// (Final, RequiredAPI, BlueprintAuthorityOnly, BlueprintCosmetic, Net, NetReliable, NetRequest, Exec, Native, Event, NetResponse, Static, NetMulticast)

void UPathFollowingComponent::STATIC_OnUpdatePath__DelegateSignature()
{
	static auto fn = UObject::FindObject<UFunction>("DelegateFunction AIModule.PathFollowingComponent.OnUpdatePath__DelegateSignature");

	UPathFollowingComponent_OnUpdatePath__DelegateSignature_Params params;
...
// bool                           bDeferredSpawn                 (Parm, ZeroConstructor, IsPlainOldData)
// class APawn*                   ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

class APawn* UAIBlueprintHelperLibrary::SpawnAIFromClass(class UObject* WorldContextObject, class UClass* PawnClass, class UBehaviorTree* BehaviorTree, const struct FVector& Location, const struct FRotator& Rotation, bool bNoCollisionFail, bool bDeferredSpawn)
{
	...
	params.bDeferredSpawn = bDeferredSpawn;
...
void UAISense_Damage::STATIC_ReportDamageEvent(class UObject* WorldContextObject, class AActor* DamagedActor, class AActor* Instigator, float DamageAmount, const struct FVector& EventLocation, const struct FVector& HitLocation, const struct FName& Tag)
{
...
void UBlackboardComponent::STATIC_SetValueAsString(const struct FName& KeyName, const class FString& StringValue)
{
...
void UPawnAction_BlueprintBase::STATIC_ActionFinished(class APawn* ControlledPawn, TEnumAsByte<EPawnActionResult> WithResult)
{
