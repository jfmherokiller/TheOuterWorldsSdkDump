...
#include "Indi_MediaAssets_parameters.hpp"
...
void UFileMediaSource::STATIC_SetFilePath(const class FString& Path)
{
...
void UMediaPlayer::STATIC_SetTimeDelay(const struct FTimespan& TimeDelay)
{
...
void UMediaPlayer::STATIC_SetBlockOnTime(const struct FTimespan& Time)
{
...
void UMediaPlayer::STATIC_GetSupportedRates(bool Unthinned, TArray<struct FFloatRange>* OutRates)
{
...
void UMediaSoundComponent::STATIC_SetMediaPlayer(class UMediaPlayer* NewMediaPlayer)
{
...
// (BlueprintCosmetic, NetReliable, Exec)
// Parameters:
...
void UMediaTexture::STATIC_SetMediaPlayer(class UMediaPlayer* NewMediaPlayer)
{
