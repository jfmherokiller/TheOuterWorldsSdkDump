...
#include "Indi_NewCover_parameters.hpp"
...
TArray<class UDecisionTreeRequestData*> UNewCover_C::RunDecisionTree(class AIndianaAiCharacter** Owner, struct FName* EventType, class UAIEventInfo** EventInfo, EDecisionTreeRequestPriority* OutPriority)
{
	static auto fn = UObject::FindObject<UFunction>("Function NewCover.NewCover_C.RunDecisionTree");

	UNewCover_C_RunDecisionTree_Params params;
	params.Owner = Owner;
