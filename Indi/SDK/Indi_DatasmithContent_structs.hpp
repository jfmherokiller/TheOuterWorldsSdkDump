...
#include "Indi_CinematicCamera_classes.hpp"
...
struct FDatasmithCameraFilmbackSettingsTemplate
{
	...
	float                                              SensorHeight;                                             // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FDatasmithPostProcessSettingsTemplate
{
	...
	float                                              WhiteTemp;                                                // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              VignetteIntensity;                                        // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                FilmWhitePoint;                                           // 0x0000(0x0010) (ZeroConstructor, IsPlainOldData)
	struct FVector4                                    ColorSaturation;                                          // 0x0000(0x0010) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EAutoExposureMethod>                   AutoExposureMethod;                                       // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	float                                              CameraISO;                                                // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FDatasmithStaticMeshImportOptions
{
	...
	EDatasmithImportLightmapMax                        MaxLightmapResolution;                                    // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bGenerateLightmapUVs;                                     // 0x0000(0x0001) (BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData)
	bool                                               bRemoveDegenerates;                                       // 0x0000(0x0001) (BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData)
...
struct FDatasmithImportBaseOptions
{
	...
	bool                                               bIncludeGeometry;                                         // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bIncludeMaterial;                                         // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bIncludeLight;                                            // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bIncludeCamera;                                           // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	struct FDatasmithAssetImportOptions                AssetOptions;                                             // 0x0000(0x0008) (BlueprintVisible)
	struct FDatasmithStaticMeshImportOptions           StaticMeshOptions;                                        // 0x0000(0x0004) (Edit, BlueprintVisible, Config)
...
struct FDatasmithTessellationOptions
{
	...
	float                                              MaxEdgeLength;                                            // 0x0000(0x0004) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	float                                              NormalTolerance;                                          // 0x0000(0x0004) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
...
struct FDatasmithReimportOptions
{
	...
	bool                                               bRespawnDeletedActors;                                    // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FDatasmithMeshBuildSettingsTemplate
{
	...
	int                                                MinLightmapResolution;                                    // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SrcLightmapIndex;                                         // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                DstLightmapIndex;                                         // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FDatasmithStaticMaterialTemplate
{
	...
	class UMaterialInterface*                          MaterialInterface;                                        // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
