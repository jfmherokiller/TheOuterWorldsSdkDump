...
#include "Indi_HeadMountedDisplay_parameters.hpp"
...
void UMotionControllerComponent::STATIC_SetTrackingSource(EControllerHand NewSource)
{
...
void UMotionControllerComponent::STATIC_SetTrackingMotionSource(const struct FName& NewSource)
{
...
void UMotionControllerComponent::STATIC_SetShowDeviceModel(bool bShowControllerModel)
{
...
void UMotionControllerComponent::STATIC_SetDisplayModelSource(const struct FName& NewDisplayModelSource)
{
...
void UMotionControllerComponent::STATIC_SetCustomDisplayMesh(class UStaticMesh* NewDisplayMesh)
{
...
void UMotionControllerComponent::STATIC_SetAssociatedPlayerIndex(int NewPlayer)
{
...
void UMotionControllerComponent::STATIC_OnMotionControllerUpdated()
{
